...
@section('content')
    ...
    <h1 class="mb-4 " style="color: #8ebf42"><b>Catering Ministry  </b></h1> 
<p style="font-size:17px">

Ruiru Chapel Church is a welcoming church seeking to love and serve God and people.  This team caters for informal gatherings, formal events, functions and parties, catering for different group sizes, with food.  This can include formal meals, buffets, and light meals.<br><br>

Why does the Ministry exist? – Our vision is to love and share God with our local community.  1 Peter 4 v 9 tells us ‘to be hospitable to one another without grumbling. As each one has received a gift, minister it to one another, as good stewards of the manifold grace of God.’<br><br>

When – For particular occasions and events<br><br>

Where– Ruiru Chapel Church
</p>
