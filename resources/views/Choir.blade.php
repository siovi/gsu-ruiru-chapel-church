...
@section('content')
    ...
    <h1 class="mb-4 " style="color: #8ebf42"><b>Choir Ministry  </b></h1> 
<p style="font-size:17px">

Church music is coordinated by the Choir department. Ruiru Chapel Church Choir is a group of church workers trained and rehearsed for the specific task of leading the songs in church services. The choir has a requisite role in church worship.

The choir has a variety of responsibilities, but their primary role is to support and enhance the congregation in singing ministerial songs. As such, the choir becomes an important leader in ministering through songs.
</p>
