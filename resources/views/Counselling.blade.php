...
@section('content')
    ...
    <h1 class="mb-4 " style="color: #8ebf42"><b>Counselling </b></h1> 
<p style="font-size:17px">Life isn´t always easy and at some points in our lives we can really need to sit down and talk with someone.<br><br>

If you are in such a situation we can offer both professional counsellors, pastors and also laymen (male and female) that would be willing to spend some time listening to you and hopefully helping and supporting you.<br><br>

All of our counsellors, pastors and laymen counsellors exercise professional confidentiality and will not pass on what you wish to confide in them.<br><br>

Our professional counsellors and pastors also are covered by their occupational confidentiality which means that even in case of legal trial they cannot be forced to disclose any details from confidential counselling conversations.<br><br>

 If you want to book a talk or counselling appointment please send an e-mail to: ------</p>
 <p><a href="{{ url('/Contact') }}" id="apply-btn" class="btn btn-info py-2 px-4 btn-center">Contact us</a> </p>    
