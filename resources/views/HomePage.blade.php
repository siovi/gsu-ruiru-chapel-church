...
@section('content')
        ...
        <div class="slider-item js-fullheight" style="background-image:url('/images/IMG_20191216_182059.jpg);">
            <div class="overlay"></div>
              <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-8 text-center ftco-animate mt-5">
                <a class="navbar-brand" href="{{ url('/home') }}" style="color: white"><span class="flaticon-bible"></span><b>Ruiru  Church</b></a>
                    <div class="text">
                        <div class="subheading">
                            <span>Ruiru Chapel Church</span>
                        </div>
        ...
        <div class="slider-item js-fullheight" style="background-image:url(/images/IMG_20191215_132801.jpg);">
            <div class="overlay"></div>
              <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
  
                <div class="col-md-8 text-center ftco-animate mt-5">
                <a class="navbar-brand" href="{{ url('/home') }}" style="color: white"><span class="flaticon-bible"></span><b>Ruiru </b></a>
                    <div class="text">
                        <div class="subheading">
                            <span>Ruiru  Church</span>
                        </div>
