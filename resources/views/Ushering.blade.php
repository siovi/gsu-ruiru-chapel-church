...
@section('content')
		...
		<section class="ftco-section bg-light ftco-event" id="events-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">Ministries</span>
            <h2 class="mb-5">Ushering</h2>
          </div>
        </div>
        <section class="ftco-section contact-section ftco-no-pb" id="contact-section">
      <div class="container">
    <div class="row">
    <div class=" container  mb-7 pl-7px col-lg-10">
    <h1 class="mb-4 " style="color: #8ebf42"><b>Ushers </b></h1> 
<p style="font-size:17px">We as the ushers at Ruiru Chapel Church welcome you to our Services every Sunday. We do this with joy and pleasure offering a warm word of welcome with a smile of love on our faces.<br><br>

We are usually one of the first people to get to the church building in order to prepare in good time before the service starts. We are also one of the last people to leave  as we are in charge of locking up the building.<br><br>

At Ruiru Chapel Church  we have a large number of visitors staying for either longer or shorter periods of time here in Gothenburg and therefore we are continually in need of new ushers in order to be able to offer a high level of service to the visitors of our Church.<br><br>

Serving in a team is fun and it is also a very good way to get friends in the church as we come closer to each other as we serve side by side. It is a great honor to serve in the house of the Lord. What a privilege! You will never regret investing your time in serving the Church. Moreover, this will help you grow and mature in the Lord even more.<br><br>

Welcome to come and talk to any one of us so that we can tell you more about being an usher and the possibility of joining us.</p>
<p><a href="{{ url('/join_Ministry') }}" id="apply-btn" class="btn btn-info py-2 px-4 btn-center">Be part of us</a> <a href="{{ url('/Vission') }}" class="btn btn-primary btn-outline-primary py-2 px-4">Read more</a></p>  
 </section >
