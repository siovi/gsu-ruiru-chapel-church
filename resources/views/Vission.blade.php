...
@section('content')
		...
		<section class="ftco-section bg-light ftco-event" id="events-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-5">Vision &amp; Mission</h2>
          </div>
        </div>
...
<h2 class="mb-4" style="color: #8ebf42">vision</h2>
           <p itemprop="description">Our vision is to see people <em>saved, healed, set free, discipled, equipped, empowered,</em> and <em>serving.</em></p>
		   <h2 class="mb-4" style="color: #8ebf42">Mission</h2>
        <p itemprop="description">

          Our mission is to help each person at Gateway <em>believe</em> in Jesus, <em>belong</em> to
          family, <em>become</em> a follower, and <em>build</em> God's kingdom.
        </p> </div>
        </div>
	  </section>
