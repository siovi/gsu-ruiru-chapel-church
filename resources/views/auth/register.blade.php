    ...
    <div class="cls-content-lg panel">
        <div class="panel-body">
            <div class="mar-ver pad-btm text-light">
                <h1 class="h3 text-light">Create a New User Account</h1>
                <p>Set up account.</p>
            </div>
            @if (isset($_GET['s']))
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <input id="branchname" placeholder="Username" type="text" class="form-control{{ $errors->has('branchname') ? ' is-invalid' : '' }}" name="branchname" value="{{ old('branchname') }}" required autofocus>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <input id="branchcode" placeholder="Code" type="text" class="form-control{{ $errors->has('branchcode') ? ' is-invalid' : '' }}" name="branchcode" value="{{ old('branchcode') }}" required>
