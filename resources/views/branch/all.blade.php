...
$(document).ready(function () {
  ...
  users_table = $('#users-table').DataTable({
      ...
      columns: [
          ...
          { title: "Username", data: 'branchname', name: 'branchname'},
          { title: "Address", data: 'address', name: 'address' },
          { title: "Code", data: 'branchcode', name: 'branchcode', render: (code) => (`
            <div class="btn-group">
          ...
          { title: "Role", data: 'isadmin', name: 'isadmin', render: (bool) => (`
            ${(bool === 'true') ? '<strong>Admin</strong>' : 'User'}
            `)
          },
    ...
    columns = $(this).parent().closest('tr').find('td').each(function(){
      if (i == 2) {
        ...
        `)
          ...
          $(this).html(`
            <div class="col-md-12">
              <input id="demo-form-radio" class="magic-radio" value="true" type="radio" name="isadmin" ${(strim($(this).text()) === 'true') ? 'checked=""' : ''}>
              <label for="demo-form-radio">Admin</label>
              <input id="demo-form-radio-2" class="magic-radio" value="false" type="radio" name="isadmin" ${(strim($(this).text()) === 'false') ? 'checked=""' : ''}>
              <label for="demo-form-radio-2">User</label>
            </div>
          `)
