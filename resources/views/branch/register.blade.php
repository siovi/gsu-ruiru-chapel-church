			...
			<div class="col-lg-8 col-lg-offset-2">
		        ...
		        <div class="cls-content-lg panel">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input id="branchname" placeholder="Username" type="text" class="form-control{{ $errors->has('Username') ? ' is-invalid' : '' }}" name="branchname" value="{{ old('branchname') }}" required autofocus>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input id="branchcode" placeholder="Code" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="branchcode" value="{{ old('branchcode') }}" required>
                    ...
                    <div class="row">
											<div class="col-sm-6">
													<div class="form-group">
															<textarea type="text" class="form-control" placeholder="User Address" name="address"></textarea>
											...
											<div class="col-sm-6">
													<div class="form-group">
                                      <select class="form-control" name="isadmin"  required="required" type="text">
