...
@section('title') All HBC groups @endsection
...
<div id="content-container">
    <div id="page-head">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div id="page-title">
            <h1 class="page-header text-overflow">Home Based Church Groups</h1>
        </div>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End page title-->
    ...
    @if (session('status'))
        ...
        <div class="panel"  style="background-color: #e8ddd3;">
            <div class="panel-heading">
                <h3 class="panel-title text-center">List of Groups </strong></h3>
            </div>
