                    ...
                    <div class="panel messages-panel">
                        <div class="contacts-list">
                            <div class="inbox-categories">
                                ...
                                <div data-toggle="tab" data-target="#online,#welcome-box" onclick="clr_msg_box();"> Active Users </div>
                                    ...
                                    <div class="contacts-outter">
                                        <ul class="list-unstyled contacts dark">
                                            <li data-toggle="tab" data-target="#draft-message-1">
                                                ...
                                                <div class="vcentered info-combo">
                                                    <h3 class="no-margin-bottom name"> Jonathan Siovi </h3>
                                                    <h5> Hello, Siovi, can you send me the latest pack of icons, I need </h5>
                                                </div>
                                                <div class="contacts-add">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane message-body" id="inbox-message">
                                <div class="message-top bg-primary">
                                    ...
                                    <div class="">
                                      <h1 class="text-center text-white">POWERED BY JONATHAN SIOVI WANJALA</h1>
                                    </div>
                                </div>
