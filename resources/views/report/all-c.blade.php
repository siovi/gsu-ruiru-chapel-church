...
@section('title') All Users Collection Report @endsection
...
<div id="content-container">
  ...
  <div id="page-content">
    <div class="row">
        ...
        <?php $currency = \Auth::user()->currency_symbol; ?>
        <div class="col-md-8 col-md-offset-2" style="margin-bottom:20px">
          <div class="panel" style="background-color: #e8ddd3;">
              <div class="panel-heading">
                  <h3 class="panel-title"><strong>Collections Report</strong></h3>
              </div>
        ...
        <div class="col-md-8 col-md-offset-2" style="margin-bottom:20px">
          <div class="panel" style="background-color: #e8ddd3;">
              <div class="panel-heading">
                  <h3 class="panel-title"><strong>Total Users Collections</strong></h3>
              </div>
            <div class="panel-body">
              <table class="table text-center">
                <thead class="bg-warning text-center">
