...
@section('content')
		...
		<section class="ftco-section bg-light ftco-event" id="events-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-5">Women’s Ministry</h2>
          </div>
        </div>
    ...
    <h1 class="mb-4 " style="color: #8ebf42"><b>Women’s Ministry </b></h1> 
<p style="font-size:17px">

Women’s Ministry is a ministry that was founded with the purpose of bringing women together in a social atmosphere to learn, share and grow together.<br><br>

Aim:

    Titus 2:3-5 to learn from each other’s faith in Jesus Christ and experiences.<br>
    Ephesians 4:28 to share our gifts and resources as well as establish a network to create lucrative ideas and work opportunities.<br>
    Ephesians 2:10 to do God’s work that He has prepared for us. Advancing God’s kingdom through ministries that equip women to grow, serve, and reach out with the gospel of Jesus Christ.<br><br>

Who: Women of all ages, sizes and races.<br><br>



Action:

    Meet together in a more informal setting to worship and share from the word of God. We encourage dialogue where we discuss the word shared and question and answer type of interaction.<br>
    Carry each others’ burdens and joys in prayer.<br>
    Recognize and celebrate each others’ special days; birthdays, weddings,baby-delivery days, graduation and any other special occasion.<br>
    Mobilize mission possibilities eg, to the homeless, hospitals, prisons, streets etc.<br>
    Plan fun entertaining activities so as to be glad and enjoy together.<br>
 </p>
