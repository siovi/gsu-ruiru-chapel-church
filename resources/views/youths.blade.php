...
@section('content')
		...
		<section class="ftco-section bg-light ftco-event" id="events-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-5">Youth Ministry</h2>
          </div>
        </div>
    ...
    <h1 class="mb-4 " style="color: #8ebf42"><b>Youth Ministry </b></h1> 
<p style="font-size:17px">Youth Ministry

Mission:

To build a Kingdom minded generation that will take transformation to the Nations.<br><br>

Aim:<br>

    To be rooted and built up in Christ Jesus.<br>
    To be strengthened in the faith.<br>
    To be examples in speech, conduct, love, faith and purity.<br>
    To share and enjoy each other’s lives.<br><br>
    To sharpen our gifts and talents through service.<br>

Colossians 2:8-9, 1Timothy 4:1-15 and Acts 2:42-45<br>

Age Group:<br><br>

Teens<br><br>

This is for those that are 13 yrs to 20 yrs old<br><br>

Young Adults<br><br>

This is for those that are 21 yrs to 35 yrs old<br><br>
 </p>
